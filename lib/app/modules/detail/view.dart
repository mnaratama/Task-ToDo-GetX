...
import 'package:todogetx/app/modules/detail/widgets/doing_list.dart';
import 'package:todogetx/app/modules/detail/widgets/done_list.dart';
                                ...
                                onPressed: () {
                                  if (homeCtrl.formKey.currentState!
                                    ...
                                    var success = homeCtrl
                                        .addTodo(homeCtrl.editCtrl.text);
                                    if (success) {
